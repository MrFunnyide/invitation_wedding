            ...
            <div class=" d-flex flex-column justify-content-center position-relative" style="height: 100vh !important; background-color: #FEFEF6;">
                  <div class="card card-shadow m-3 p-4 font-standard" style="border-radius: 10px 120px 10px 10px; height: 55vh;">
                        <div style="color: #B17C20;">
                              <h1 style="font-size: 2.5rem;">Putra</h1>
                              <h6 style="font-size: 2rem;"><i>&</i></h6>
                              <h1 style="font-size: 2.5rem;">Mayu</h1>
                              <hr>
                        </div>
            ...
            <div class="d-flex flex-column justify-content-center position-relative" style="height: 100vh !important;background-color: #FEFEF6;">
                  <div class="card m-3 card-shadow p-4 text-end font-standard" style="border-radius: 120px 10px 10px 10px; height: 60vh;" data-aos="fade-left" data-aos-duration="3000">
                        ...
                        <di class="mt-5">
                              ...
                              <p style="font-size: 1rem;">Putri dari Bapak Suwardi & Ibu Ety Suyati</p>
                              <p style="font-size: 2rem;">&</p>
                              <h4 style="color: #B17C20; font-size: 1.5rem;">Maytizen Saputra</h4>
            ...
            <div class="d-flex flex-column justify-content-center position-relative" style="height: 100vh !important; background-color: #FEFEF6;">
                  <div class="card m-3 card-shadow p-5 text-center font-standard rounded-top-pill" style="height: 70vh;" data-aos="fade-up" data-aos-duration="3000">
                        ...
                        <div style="font-size: 0.9rem;">
                              ...
                              <p>Jl.Darussalam, Kec. Mempura, Kota Siak Sri
                                    Indrapura, Riau 28773</p>
                        </div>
